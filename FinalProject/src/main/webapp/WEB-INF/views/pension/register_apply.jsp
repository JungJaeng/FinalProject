...
<div class="container">
    <form action="/pension/register_apply" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        ontrol" name="room_name">
      </div>
      
      <div class="form-group">
        <label for="room_content">객실 소개</label><br>
        <textarea class="form-c" id="summernote" name="room_content"></textarea>
      </div>
      
      <div class="form-group">
        <label for="room_personnel">인원</label><br>
        <input type="text" class="form-c" name="room_men">
      </div>
      
      <div class="form-group">
        <label for="room_size">크기</label><br>
        <input type="text" class="form-c" name="room_size">
      </div>
      
       <div class="form-group">
        <label for="room_price">요금</label><br>
        <input type="text" class="form-c" name="room_price">
      </div>  
